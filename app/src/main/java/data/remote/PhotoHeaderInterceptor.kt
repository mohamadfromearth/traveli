...
class PhotoHeaderInterceptor @Inject constructor(@ApplicationContext private val appClass: ApplicationClass, private val languageManager: LanguageManager) : Interceptor {
